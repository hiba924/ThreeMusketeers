...
public class ThreeMusketeers {
    ...
    protected void move(final Agent agent) {
        var originalMove = agent.getMove();
        var copyMove = new Move(originalMove);
        moves.add(copyMove);
        board.move(originalMove);
       // System.out.println(board);
    }
    ...
    private void undoMove() {
        ...
        var removedMove = moves.remove(index);
        board.undoMove(removedMove);
        int index2 = moves.size()-1;
        var removedMove2 = moves.remove(index2);
        board.undoMove(removedMove2);
    }
